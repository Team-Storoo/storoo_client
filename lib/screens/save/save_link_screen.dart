...
class SaveLinkScreen extends StatefulWidget {
  ...
  const SaveLinkScreen({super.key, this.onSaved});
...
class _SaveLinkScreenState extends State<SaveLinkScreen> {
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  const _SectionLabel('링크', isRequired: true),
  ...
  Widget _buildFolderGrid() {
    // +1 slot for "폴더 만들기" card (only when under limit)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: const Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.create_new_folder_outlined, color: AppColors.textSecondary, size: 26),
            SizedBox(height: 6),
            Text(
              '폴더 만들기',
              style: TextStyle(
