...
/// 필수: 링크 URL, 제목, 저장 폴더
/// 선택: 메모(최대 200자), 태그
class LinkSaveScreen extends StatefulWidget {
  const LinkSaveScreen({super.key});

  @override
  State<LinkSaveScreen> createState() => _LinkSaveScreenState();
}

class _LinkSaveScreenState extends State<LinkSaveScreen> {
